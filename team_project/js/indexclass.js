...
var details1' <div data-name="' + twodayClass.name + '" data-flag="' + twodayClass.flags ;
     var details1 += '"> <a href="twoday.html"><img src="images/twoday.jpg" class="image" alt="«Class»"> ’;
    var details1 +=  ' <h4> ' + twodayClass.name +  '  </h4></a></div>  ';
...
var details2' <div data-name="' + cook42Class.name + '" data-flag="' + cook42Class.flags ;
     var details2 += '"> <a href="cook42.html"><img src="images/cook42.jpg" class="image" alt="«Class»"> ’;
    var details2 +=  ' <h4> ' + cook42Class.name +  '  </h4></a></div>  ';
...
var details3' <div data-name="' + salmonClass.name + '" data-flag="' + salmonClass.flags ;
     var details3 += '"> <a href="salmon.html"><img src="images/salmon.jpg" class="image" alt="«Class»"> ’;
    var details3 +=  ' <h4> ' + salmonClass.name +  '  </h4></a></div>  ';
...
var details4' <div data-name="' + agingClass.name + '" data-flag="' + agingClass.flags ;
     var details4 += '"> <a href="aging.html"><img src="images/aging.jpg" class="image" alt="«Class»"> ’;
    var details4 +=  ' <h4> ' + agingClass.name +  '  </h4></a></div>  ';
...
var details5' <div data-name="' + pieClass.name + '" data-flag="' + pieClass.flags ;
     var details5 += '"> <a href="pie.html"><img src="images/pie.jpg" class="image" alt="«Class»"> ’;
    var details5 +=  ' <h4> ' + pieClass.name +  '  </h4></a></div>  ';
...
var details6' <div data-name="' + antiClass.name + '" data-flag="' + antiClass.flags ;
     var details6 += '"> <a href="anti.html"><img src="images/anti.jpg" class="image" alt="«Class»"> ’;
    var details6 +=  ' <h4> ' + antiClass.name +  '  </h4></a></div>  ';
...
var details7' <div data-name="' + enchiladasClass.name + '" data-flag="' + enchiladasClass.flags ;
     var details7 += '"> <a href="enchiladas.html"><img src="images/enchiladas.jpg" class="image" alt="«Class»"> ’;
    var details7 +=  ' <h4> ' + enchiladasClass.name +  '  </h4></a></div>  ';
...
var details8' <div data-name="' + atwClass.name + '" data-flag="' + atwClass.flags ;
     var details8 += '"> <a href="atw.html"><img src="images/atw.jpg" class="image" alt="«Class»"> ’;
    var details8 +=  ' <h4> ' + atwClass.name +  '  </h4></a></div>  ';
...
var details9' <div data-name="' + atwClass.name + '" data-flag="' + atwClass.flags ;
     var details9 += '"> <a href="atw.html"><img src="images/atw.jpg" class="image" alt="«Class»"> ’;
    var details9 +=  ' <h4> ' + atwClass.name +  '  </h4></a></div>  ';
...
var details10' <div data-name="' + breadClass.name + '" data-flag="' + breadClass.flags ;
     var details10 += '"> <a href="bread.html"><img src="images/bread.jpg" class="image" alt="«Class»"> ’;
    var details10 +=  ' <h4> ' + breadClass.name +  '  </h4></a></div>  ';
...
var details11' <div data-name="' + basqueClass.name + '" data-flag="' + basqueClass.flags ;
     var details11 += '"> <a href="basque.html"><img src="images/basque.jpg" class="image" alt="«Class»"> ’;
    var details11 +=  ' <h4> ' + basqueClass.name +  '  </h4></a></div>  ';
...
var details12' <div data-name="' + batterClass.name + '" data-flag="' + batterClass.flags ;
     var details12 += '"> <a href="batter.html"><img src="images/batter.jpg" class="image" alt="«Class»"> ’;
    var details12 +=  ' <h4> ' + batterClass.name +  '  </h4></a></div>  ';
...
var details13' <div data-name="' + cheeseClass.name + '" data-flag="' + cheeseClass.flags ;
     var details13 += '"> <a href="cheese.html"><img src="images/cheese.jpg" class="image" alt="«Class»"> ’;
    var details13 +=  ' <h4> ' + cheeseClass.name +  '  </h4></a></div>  ';
...
var details14' <div data-name="' + chickenClass.name + '" data-flag="' + chickenClass.flags ;
     var details14 += '"> <a href="chicken.html"><img src="images/chicken.jpg" class="image" alt="«Class»"> ’;
    var details14 +=  ' <h4> ' + chickenClass.name +  '  </h4></a></div>  ';
...
var details15' <div data-name="' + cldrollsClass.name + '" data-flag="' + cldrollsClass.flags ;
     var details15 += '"> <a href="cldrolls.html"><img src="images/cldrolls.jpg" class="image" alt="«Class»"> ’;
    var details15 +=  ' <h4> ' + cldrollsClass.name +  '  </h4></a></div>  ';
...
var details16' <div data-name="' + noodlesClass.name + '" data-flag="' + noodlesClass.flags ;
     var details16 += '"> <a href="noodles.html"><img src="images/noodles.jpg" class="image" alt="«Class»"> ’;
    var details16 +=  ' <h4> ' + noodlesClass.name +  '  </h4></a></div>  ';
...
var details17' <div data-name="' + frenchClass.name + '" data-flag="' + frenchClass.flags ;
     var details17 += '"> <a href="french.html"><img src="images/french.jpg" class="image" alt="«Class»"> ’;
    var details17 +=  ' <h4> ' + frenchClass.name +  '  </h4></a></div>  ';
...
var details18' <div data-name="' + klatchClass.name + '" data-flag="' + klatchClass.flags ;
     var details18 += '"> <a href="klatch.html"><img src="images/klatch.jpg" class="image" alt="«Class»"> ’;
    var details18 +=  ' <h4> ' + klatchClass.name +  '  </h4></a></div>  ';
...
var details19' <div data-name="' + cwrClass.name + '" data-flag="' + cwrClass.flags ;
     var details19 += '"> <a href="cwr.html"><img src="images/cwr.jpg" class="image" alt="«Class»"> ’;
    var details19 +=  ' <h4> ' + cwrClass.name +  '  </h4></a></div>  ';
...
var details20' <div data-name="' + spsoupClass.name + '" data-flag="' + spsoupClass.flags ;
     var details20 += '"> <a href="spsoup.html"><img src="images/spsoup.jpg" class="image" alt="«Class»"> ’;
    var details20 +=  ' <h4> ' + spsoupClass.name +  '  </h4></a></div>  ';
...
var details21' <div data-name="' + veganClass.name + '" data-flag="' + veganClass.flags ;
     var details21 += '"> <a href="vegan.html"><img src="images/vegan.jpg" class="image" alt="«Class»"> ’;
    var details21 +=  ' <h4> ' + veganClass.name +  '  </h4></a></div>  ';
...
var details22' <div data-name="' + fermClass.name + '" data-flag="' + fermClass.flags ;
     var details22 += '"> <a href="ferm.html"><img src="images/ferm.jpg" class="image" alt="«Class»"> ’;
    var details22 +=  ' <h4> ' + fermClass.name +  '  </h4></a></div>  ';
...
var details23' <div data-name="' + heartClass.name + '" data-flag="' + heartClass.flags ;
     var details23 += '"> <a href="heart.html"><img src="images/heart.jpg" class="image" alt="«Class»"> ’;
    var details23 +=  ' <h4> ' + heartClass.name +  '  </h4></a></div>  ';
...
var details24' <div data-name="' + fondueClass.name + '" data-flag="' + fondueClass.flags ;
     var details24 += '"> <a href="fondue.html"><img src="images/fondue.jpg" class="image" alt="«Class»"> ’;
    var details24 +=  ' <h4> ' + fondueClass.name +  '  </h4></a></div>  ';
...
var details25' <div data-name="' + gfwttClass.name + '" data-flag="' + gfwttClass.flags ;
     var details25 += '"> <a href="gfwtt.html"><img src="images/gfwtt.jpg" class="image" alt="«Class»"> ’;
    var details25 +=  ' <h4> ' + gfwttClass.name +  '  </h4></a></div>  ';
...
var details26' <div data-name="' + gfbakingClass.name + '" data-flag="' + gfbakingClass.flags ;
     var details26 += '"> <a href="gfbaking.html"><img src="images/gfbaking.jpg" class="image" alt="«Class»"> ’;
    var details26 +=  ' <h4> ' + gfbakingClass.name +  '  </h4></a></div>  ';
...
var details27' <div data-name="' + budgetClass.name + '" data-flag="' + budgetClass.flags ;
     var details27 += '"> <a href="budget.html"><img src="images/budget.jpg" class="image" alt="«Class»"> ’;
    var details27 +=  ' <h4> ' + budgetClass.name +  '  </h4></a></div>  ';
...
var details28' <div data-name="' + sardiniaClass.name + '" data-flag="' + sardiniaClass.flags ;
     var details28 += '"> <a href="sardinia.html"><img src="images/sardinia.jpg" class="image" alt="«Class»"> ’;
    var details28 +=  ' <h4> ' + sardiniaClass.name +  '  </h4></a></div>  ';
...
var details29' <div data-name="' + cakeClass.name + '" data-flag="' + cakeClass.flags ;
     var details29 += '"> <a href="cake.html"><img src="images/cake.jpg" class="image" alt="«Class»"> ’;
    var details29 +=  ' <h4> ' + cakeClass.name +  '  </h4></a></div>  ';
...
var details30' <div data-name="' + seasonClass.name + '" data-flag="' + seasonClass.flags ;
     var details30 += '"> <a href="season.html"><img src="images/season.jpg" class="image" alt="«Class»"> ’;
    var details30 +=  ' <h4> ' + seasonClass.name +  '  </h4></a></div>  ';
...
var details31' <div data-name="' + indianClass.name + '" data-flag="' + indianClass.flags ;
     var details31 += '"> <a href="indian.html"><img src="images/indian.jpg" class="image" alt="«Class»"> ’;
    var details31 +=  ' <h4> ' + indianClass.name +  '  </h4></a></div>  ';
...
var details32' <div data-name="' + chemClass.name + '" data-flag="' + chemClass.flags ;
     var details32 += '"> <a href="chem.html"><img src="images/chem.jpg" class="image" alt="«Class»"> ’;
    var details32 +=  ' <h4> ' + chemClass.name +  '  </h4></a></div>  ';
...
var details33' <div data-name="' + knifeClass.name + '" data-flag="' + knifeClass.flags ;
     var details33 += '"> <a href="knife.html"><img src="images/knife.jpg" class="image" alt="«Class»"> ’;
    var details33 +=  ' <h4> ' + knifeClass.name +  '  </h4></a></div>  ';
...
var details34' <div data-name="' + dumplingClass.name + '" data-flag="' + dumplingClass.flags ;
     var details34 += '"> <a href="dumpling.html"><img src="images/dumpling.jpg" class="image" alt="«Class»"> ’;
    var details34 +=  ' <h4> ' + dumplingClass.name +  '  </h4></a></div>  ';
...
var details35' <div data-name="' + panClass.name + '" data-flag="' + panClass.flags ;
     var details35 += '"> <a href="pan.html"><img src="images/pan.jpg" class="image" alt="«Class»"> ’;
    var details35 +=  ' <h4> ' + panClass.name +  '  </h4></a></div>  ';
...
var details36' <div data-name="' + medClass.name + '" data-flag="' + medClass.flags ;
     var details36 += '"> <a href="med.html"><img src="images/med.jpg" class="image" alt="«Class»"> ’;
    var details36 +=  ' <h4> ' + medClass.name +  '  </h4></a></div>  ';
...
var details37' <div data-name="' + piemonteseClass.name + '" data-flag="' + piemonteseClass.flags ;
     var details37 += '"> <a href="piemontese.html"><img src="images/piemontese.jpg" class="image" alt="«Class»"> ’;
    var details37 +=  ' <h4> ' + piemonteseClass.name +  '  </h4></a></div>  ';
...
var details38' <div data-name="' + mexClass.name + '" data-flag="' + mexClass.flags ;
     var details38 += '"> <a href="mex.html"><img src="images/mex.jpg" class="image" alt="«Class»"> ’;
    var details38 +=  ' <h4> ' + mexClass.name +  '  </h4></a></div>  ';
...
var details39' <div data-name="' + bagelsClass.name + '" data-flag="' + bagelsClass.flags ;
     var details39 += '"> <a href="bagels.html"><img src="images/bagels.jpg" class="image" alt="«Class»"> ’;
    var details39 +=  ' <h4> ' + bagelsClass.name +  '  </h4></a></div>  ';
...
var details40' <div data-name="' + nwcelClass.name + '" data-flag="' + nwcelClass.flags ;
     var details40 += '"> <a href="nwcel.html"><img src="images/nwcel.jpg" class="image" alt="«Class»"> ’;
    var details40 +=  ' <h4> ' + nwcelClass.name +  '  </h4></a></div>  ';
...
var details41' <div data-name="' + pulseClass.name + '" data-flag="' + pulseClass.flags ;
     var details41 += '"> <a href="pulse.html"><img src="images/pulse.jpg" class="image" alt="«Class»"> ’;
    var details41 +=  ' <h4> ' + pulseClass.name +  '  </h4></a></div>  ';
...
var details42' <div data-name="' + pastaClass.name + '" data-flag="' + pastaClass.flags ;
     var details42 += '"> <a href="pasta.html"><img src="images/pasta.jpg" class="image" alt="«Class»"> ’;
    var details42 +=  ' <h4> ' + pastaClass.name +  '  </h4></a></div>  ';
...
var details43' <div data-name="' + pizzaClass.name + '" data-flag="' + pizzaClass.flags ;
     var details43 += '"> <a href="pizza.html"><img src="images/pizza.jpg" class="image" alt="«Class»"> ’;
    var details43 +=  ' <h4> ' + pizzaClass.name +  '  </h4></a></div>  ';
...
var details44' <div data-name="' + probioticsClass.name + '" data-flag="' + probioticsClass.flags ;
     var details44 += '"> <a href="probiotics.html"><img src="images/probiotics.jpg" class="image" alt="«Class»"> ’;
    var details44 +=  ' <h4> ' + probioticsClass.name +  '  </h4></a></div>  ';
...
var details45' <div data-name="' + saucesClass.name + '" data-flag="' + saucesClass.flags ;
     var details45 += '"> <a href="sauces.html"><img src="images/sauces.jpg" class="image" alt="«Class»"> ’;
    var details45 +=  ' <h4> ' + saucesClass.name +  '  </h4></a></div>  ';
...
var details46' <div data-name="' + mealsClass.name + '" data-flag="' + mealsClass.flags ;
     var details46 += '"> <a href="meals.html"><img src="images/meals.jpg" class="image" alt="«Class»"> ’;
    var details46 +=  ' <h4> ' + mealsClass.name +  '  </h4></a></div>  ';
...
var details47' <div data-name="' + theoClass.name + '" data-flag="' + theoClass.flags ;
     var details47 += '"> <a href="theo.html"><img src="images/theo.jpg" class="image" alt="«Class»"> ’;
    var details47 +=  ' <h4> ' + theoClass.name +  '  </h4></a></div>  ';
...
var details48' <div data-name="' + rawClass.name + '" data-flag="' + rawClass.flags ;
     var details48 += '"> <a href="raw.html"><img src="images/raw.jpg" class="image" alt="«Class»"> ’;
    var details48 +=  ' <h4> ' + rawClass.name +  '  </h4></a></div>  ';
...
var details49' <div data-name="' + sauces2Class.name + '" data-flag="' + sauces2Class.flags ;
     var details49 += '"> <a href="sauces2.html"><img src="images/sauces2.jpg" class="image" alt="«Class»"> ’;
    var details49 +=  ' <h4> ' + sauces2Class.name +  '  </h4></a></div>  ';
...
var details50' <div data-name="' + detoxClass.name + '" data-flag="' + detoxClass.flags ;
     var details50 += '"> <a href="detox.html"><img src="images/detox.jpg" class="image" alt="«Class»"> ’;
    var details50 +=  ' <h4> ' + detoxClass.name +  '  </h4></a></div>  ';
...
var details51' <div data-name="' + greensClass.name + '" data-flag="' + greensClass.flags ;
     var details51 += '"> <a href="greens.html"><img src="images/greens.jpg" class="image" alt="«Class»"> ’;
    var details51 +=  ' <h4> ' + greensClass.name +  '  </h4></a></div>  ';
...
var details52' <div data-name="' + stirClass.name + '" data-flag="' + stirClass.flags ;
     var details52 += '"> <a href="stir.html"><img src="images/stir.jpg" class="image" alt="«Class»"> ’;
    var details52 +=  ' <h4> ' + stirClass.name +  '  </h4></a></div>  ';
...
var details53' <div data-name="' + shortClass.name + '" data-flag="' + shortClass.flags ;
     var details53 += '"> <a href="short.html"><img src="images/short.jpg" class="image" alt="«Class»"> ’;
    var details53 +=  ' <h4> ' + shortClass.name +  '  </h4></a></div>  ';
...
var details54' <div data-name="' + tacoClass.name + '" data-flag="' + tacoClass.flags ;
     var details54 += '"> <a href="taco.html"><img src="images/taco.jpg" class="image" alt="«Class»"> ’;
    var details54 +=  ' <h4> ' + tacoClass.name +  '  </h4></a></div>  ';
...
var details55' <div data-name="' + tamaleClass.name + '" data-flag="' + tamaleClass.flags ;
     var details55 += '"> <a href="tamale.html"><img src="images/tamale.jpg" class="image" alt="«Class»"> ’;
    var details55 +=  ' <h4> ' + tamaleClass.name +  '  </h4></a></div>  ';
...
var details56' <div data-name="' + thaiClass.name + '" data-flag="' + thaiClass.flags ;
     var details56 += '"> <a href="thai.html"><img src="images/thai.jpg" class="image" alt="«Class»"> ’;
    var details56 +=  ' <h4> ' + thaiClass.name +  '  </h4></a></div>  ';
...
var details57' <div data-name="' + brazilClass.name + '" data-flag="' + brazilClass.flags ;
     var details57 += '"> <a href="brazil.html"><img src="images/brazil.jpg" class="image" alt="«Class»"> ’;
    var details57 +=  ' <h4> ' + brazilClass.name +  '  </h4></a></div>  ';
...
var details58' <div data-name="' + grillClass.name + '" data-flag="' + grillClass.flags ;
     var details58 += '"> <a href="grill.html"><img src="images/grill.jpg" class="image" alt="«Class»"> ’;
    var details58 +=  ' <h4> ' + grillClass.name +  '  </h4></a></div>  ';
...
var details59' <div data-name="' + tomatoClass.name + '" data-flag="' + tomatoClass.flags ;
     var details59 += '"> <a href="tomato.html"><img src="images/tomato.jpg" class="image" alt="«Class»"> ’;
    var details59 +=  ' <h4> ' + tomatoClass.name +  '  </h4></a></div>  ';
...
var details60' <div data-name="' + sushiClass.name + '" data-flag="' + sushiClass.flags ;
     var details60 += '"> <a href="sushi.html"><img src="images/sushi.jpg" class="image" alt="«Class»"> ’;
    var details60 +=  ' <h4> ' + sushiClass.name +  '  </h4></a></div>  ';
...
var details61' <div data-name="' + wttClass.name + '" data-flag="' + wttClass.flags ;
     var details61 += '"> <a href="wtt.html"><img src="images/wtt.jpg" class="image" alt="«Class»"> ’;
    var details61 +=  ' <h4> ' + wttClass.name +  '  </h4></a></div>  ';
...
var details62' <div data-name="' + bugsClass.name + '" data-flag="' + bugsClass.flags ;
     var details62 += '"> <a href="bugs.html"><img src="images/bugs.jpg" class="image" alt="«Class»"> ’;
    var details62 +=  ' <h4> ' + bugsClass.name +  '  </h4></a></div>  ';
